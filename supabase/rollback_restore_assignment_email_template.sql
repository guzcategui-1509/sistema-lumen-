-- Rollback: restaura la plantilla simplificada desplegada antes del patch visual.
-- No modifica destinatarios, permisos, cola, cron, worker ni registros existentes.
...
DROP FUNCTION IF EXISTS public.escape_assignment_email_html(text);
